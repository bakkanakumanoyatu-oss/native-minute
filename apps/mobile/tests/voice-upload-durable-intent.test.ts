...
const COMPLETED_INTENT = {script_revision_id: null, script_practice_epoch: null, generation_preset: null,
  ...
  orphan_possible: null,
  recovery_evidence_ref: null,
  recovered_at: null,
  source_lifecycle_known: true,
  first_registered_at: null,
  first_registration_intent_id: null,
  cleanup_due_at: null,
  cleanup_state: "available" as const,
  ...
  registration_consent_id: null,
  registration_provider: null,
  registration_source_read_started_at: null,
  registration_dispatched_at: null,
  registration_voice_id: null,
  lease_token: null,
