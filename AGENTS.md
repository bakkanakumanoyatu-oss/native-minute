...
- For saved scripts, a valid owned reference-audio cache hit remains reusable even if the body is now over limit; a cache miss rejects new TTS before reserving a writer intent.
