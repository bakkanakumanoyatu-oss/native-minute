...
const MOBILE_API_ERROR_COPY: Record<MobileApiReasonCode, { message: string; retryable: boolean }> = {
  ...
  quota_limit_reached: { message: "今はこの操作の利用上限に達しています。", retryable: false },
  ...
  script_revision_conflict: { message: "台本が変更または削除されました。最新の台本を確認してください。", retryable: false },
  practice_state_conflict: { message: "台本が変更または削除されました。最新の台本を確認してください。", retryable: false },
