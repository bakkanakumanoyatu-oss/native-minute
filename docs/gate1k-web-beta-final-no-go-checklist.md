...
| Support contact | Gate1f / Gate1j | Public support contact and owner confirmed. | `PASS`: Web beta support contact is `nativeminutes.support@gmail.com`. | Human Check Backlog; Gate1i; support route follow-up if needed |
