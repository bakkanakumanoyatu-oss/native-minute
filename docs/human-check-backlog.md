...
| HCB-007 | Gate1f / Support | Public support contact | `PASS` | Web beta support contact is confirmed as `nativeminutes.support@gmail.com`; this is intentionally public support contact information. | Recheck before formal public launch / Store submission. |
