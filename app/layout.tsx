          ...
          <footer className="mt-10 rounded-3xl border border-[var(--line)] bg-white/75 px-4 py-4 text-sm text-ink-600 shadow-sm sm:mt-12 sm:px-5">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <nav className="flex flex-wrap gap-3 font-semibold text-ink-700">
                <Link href="/privacy" className="hover:text-[var(--accent-strong)]">Privacy</Link>
                <Link href="/terms" className="hover:text-[var(--accent-strong)]">Terms</Link>
                <Link href="/support" className="hover:text-[var(--accent-strong)]">Support</Link>
                <Link href="/support/account-deletion" className="hover:text-[var(--accent-strong)]">Account deletion</Link>
              </nav>
            </div>
          </footer>
        </div>
